...
public class BlockQuantumInterface extends BlockContainer {
	...
	public BlockQuantumInterface() {
		...
		setBlockName("quantumtileinterface");
		setCreativeTab(CreativeTabs.tabRedstone);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityQuantumInterface();
	}
	...
	public void registerBlockIcons(IIconRegister iReg) {
		icons[0] = iReg.registerIcon(TileInterfaceBase.MODID + ":quantum/front");
		icons[1] = iReg.registerIcon(TileInterfaceBase.MODID + ":quantum/back");
		icons[2] = iReg.registerIcon(TileInterfaceBase.MODID + ":quantum/up");
		icons[3] = iReg.registerIcon(TileInterfaceBase.MODID + ":quantum/right");
		icons[4] = iReg.registerIcon(TileInterfaceBase.MODID + ":quantum/down");
		icons[5] = iReg.registerIcon(TileInterfaceBase.MODID + ":quantum/left");
	}
